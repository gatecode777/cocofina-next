...
export const metadata = {
  title: 'Privacy Policy – How We Protect Your Data | Cocofina',
  description: 'Read the Cocofina Privacy Policy to understand how we collect, store, use, and protect your personal data when you shop for organic coconut sugar on our website.',
  keywords: ['Cocofina privacy policy', 'data protection coconut sugar', 'personal information Cocofina'],
  alternates: { canonical: 'https://www.cocofinasugar.com/privacy-policy' },
  robots: { index: true, follow: false },
  openGraph: {
    title: 'Privacy Policy | Cocofina',
    description: 'Learn how Cocofina collects and protects your personal information.',
    url: 'https://www.cocofinasugar.com/privacy-policy',
    type: 'website',
  },
};
