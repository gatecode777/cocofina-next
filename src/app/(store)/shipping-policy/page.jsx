...
export const metadata = {
  title: 'Shipping Policy – Delivery Times & Charges | Cocofina',
  description: 'Cocofina Shipping Policy: Free delivery on orders above ₹499. Learn about order processing time, delivery timelines across India, courier partners, and shipment tracking.',
  keywords: ['Cocofina shipping policy', 'free delivery coconut sugar India', 'Cocofina delivery time', 'order tracking Cocofina'],
  alternates: { canonical: 'https://www.cocofinasugar.com/shipping-policy' },
  robots: { index: true, follow: false },
  openGraph: {
    title: 'Shipping Policy | Cocofina',
    description: 'Free delivery on ₹499+ orders. Know our shipping timelines and tracking details.',
    url: 'https://www.cocofinasugar.com/shipping-policy',
    type: 'website',
  },
};
