...
const FaqTabs = () => {
  ...
  return (
    <div className="container">
      ...
      <div 
        id="cocofina-faq" 
        className={`faq-content ${activeTab === 'cocofina-faq' ? 'active' : ''}`} 
        style={{ display: activeTab === 'cocofina-faq' ? 'block' : 'none' }}
      >
      ...
      <div 
        id="sugar-faq" 
        className={`faq-content ${activeTab === 'sugar-faq' ? 'active' : ''}`} 
        style={{ display: activeTab === 'sugar-faq' ? 'block' : 'none' }}
      >
        <div className="faq-item">
      ...
      <div className="ask-question-container">
        ...
        <form className="ask-form" onSubmit={handleFormSubmit}>
          ...
          <div className="form-group full">
            <textarea rows="4" placeholder="Type your question" required></textarea>
          </div>
